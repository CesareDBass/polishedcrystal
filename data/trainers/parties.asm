...
FalknerGroup:
	...
	; party
	dbp 73, NOCTOWL
		db SPELL_TAG, ABIL_NOCTOWL_TINTED_LENS | NAT_SPE_UP_ATK_DOWN
		db AIR_SLASH, HEX, HYPNOSIS, DREAM_EATER
	dbp 70, SKARMORY
		db LEFTOVERS, ABIL_SKARMORY_STURDY | NAT_SPE_UP_SATK_DOWN
		db SPIKES, SCREECH, DRILL_PECK, STEEL_WING
	dbp 72, DODRIO
		db SILK_SCARF, ABIL_DODRIO_TANGLED_FEET | NAT_SPE_UP_SATK_DOWN
		db DRILL_PECK, BULLDOZE, BODY_SLAM, BRAVE_BIRD
	dbp 70, TOGEKISS
		db KINGS_ROCK, ABIL_TOGEKISS_SERENE_GRACE | NAT_SATK_UP_ATK_DOWN
		db ANCIENTPOWER, HURRICANE, NASTY_PLOT, FRESH_SNACK
	dbp 72, HONCHKROW
		db BLACKGLASSES, ABIL_HONCHKROW_MOXIE | NAT_SPE_UP_SATK_DOWN
		db BRAVE_BIRD, NIGHT_SLASH, SUCKER_PUNCH, CONFUSE_RAY
	dbp 75, PIDGEOT
		db SHARP_BEAK, ABIL_PIDGEOT_NO_GUARD | NAT_SATK_UP_ATK_DOWN
		db HURRICANE, HYPER_BEAM, FOCUS_BLAST, ROOST
	db -1 ; end
...
BugsyGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 71, BEEDRILL, FEMALE
		db KINGS_ROCK, ABIL_BEEDRILL_ADAPTABILITY | NAT_SPE_UP_SATK_DOWN
		db TOXIC_SPIKES, LEECH_LIFE, POISON_JAB, SWORDS_DANCE
	dbp 73, HERACROSS, MALE
		db BLACK_BELT, ABIL_HERACROSS_GUTS | NAT_ATK_UP_SATK_DOWN
		db MEGAHORN, CROSS_CHOP, ROCK_SMASH, STONE_EDGE
	dbp 72, SCYTHER, FEMALE
		db EVIOLITE, ABIL_SCYTHER_TECHNICIAN | NAT_ATK_UP_SATK_DOWN
		db SWORDS_DANCE, ROOST, BUG_BITE, AERIAL_ACE
	dbp 70, YANMEGA, FEMALE
		db QUICK_CLAW, ABIL_YANMEGA_TINTED_LENS | NAT_SPE_UP_ATK_DOWN
if DEF(FAITHFUL)
...
endc
	dbp 75, PINSIR, MALE
		db SCOPE_LENS, ABIL_PINSIR_MOXIE | NAT_ATK_UP_SATK_DOWN
		db MEGAHORN, SWORDS_DANCE, CLOSE_COMBAT, EARTHQUAKE
	dbp 75, SCIZOR, FEMALE
		db MUSCLE_BAND, ABIL_SCIZOR_TECHNICIAN | NAT_SPE_UP_SATK_DOWN
		db KNOCK_OFF, AERIAL_ACE, U_TURN, BULLET_PUNCH
	db -1 ; end
...
WhitneyGroup:
	...
	dbp 19, CLEFAIRY, FEMALE
		db NO_ITEM, ABIL_CLEFAIRY_UNAWARE | NAT_NEUTRAL
		ev_spread 96 HP
		db METRONOME, DISARM_VOICE, DOUBLE_SLAP, ATTRACT
	dbp 20, TEDDIURSA, FEMALE
		db NO_ITEM, ABIL_TEDDIURSA_QUICK_FEET | NAT_NEUTRAL
		ev_spread 32 HP, 32 Atk, 32 Spe
		db SCRATCH, ATTRACT, LICK, FEINT_ATTACK
	dbp 19, AIPOM, FEMALE
		db NO_ITEM, ABIL_AIPOM_PICKUP | NAT_NEUTRAL
		ev_spread 64 Atk, 32 Spe
		db ATTRACT, PAY_DAY, MUD_SLAP, FURY_STRIKES
	dbp 21, MILTANK, FEMALE
		db LUM_BERRY, ABIL_MILTANK_SCRAPPY | NAT_ATK_UP_DEF_DOWN
	...
	dbp 71, STANTLER, FEMALE
		db LIGHT_CLAY, ABIL_STANTLER_INTIMIDATE | NAT_SPE_UP_SATK_DOWN
		db REFLECT, LIGHT_SCREEN, DOUBLE_EDGE, ZEN_HEADBUTT
	dbp 72, AMBIPOM, FEMALE
		db LOADED_DICE, ABIL_AMBIPOM_TECHNICIAN | NAT_ATK_UP_SATK_DOWN
		db FURY_STRIKES, ROCK_BLAST, AERIAL_ACE, DOUBLE_SLAP
	dbp 70, CLEFABLE, FEMALE
		db LEFTOVERS, ABIL_CLEFABLE_UNAWARE | NAT_DEF_UP_ATK_DOWN
		db CALM_MIND, MOONBLAST, FRESH_SNACK, THUNDER_WAVE
	dbp 72, URSARING, FEMALE
		db FLAME_ORB, ABIL_URSARING_QUICK_FEET | NAT_ATK_UP_SATK_DOWN
		db SWORDS_DANCE, CROSS_CHOP, FACADE, PLAY_ROUGH
	dbp 74, WIGGLYTUFF, FEMALE
		db PINK_BOW, ABIL_WIGGLYTUFF_COMPETITIVE | NAT_DEF_UP_ATK_DOWN
		db FOCUS_BLAST, HYPER_VOICE, DAZZLINGLEAM, ICE_BEAM
	dbp 75, MILTANK, FEMALE
		db BRIGHTPOWDER, ABIL_MILTANK_SCRAPPY | NAT_SPE_UP_SATK_DOWN
		db ATTRACT, ROLLOUT, FRESH_SNACK, BODY_SLAM
	db -1 ; end
...
if DEF(FAITHFUL)
	...
	dbp 24, NOCTOWL, MALE
		db NO_ITEM, ABIL_NOCTOWL_KEEN_EYE | NAT_NEUTRAL
		ev_spread 64 HP, 64 Spe
		db HYPNOSIS, FORESIGHT, CONFUSION, HEX
endc
	dbp 25, MISDREAVUS, MALE
		db NO_ITEM, ABIL_MISDREAVUS_LEVITATE | NAT_NEUTRAL
		ev_spread 64 SAt, 64 Spe
		db DISARM_VOICE, DARK_PULSE, NASTY_PLOT, SHADOW_BALL
	dbp 26, GENGAR, MALE
if DEF(FAITHFUL)
		db WIDE_LENS, ABIL_GENGAR_CURSED_BODY | NAT_SATK_UP_ATK_DOWN
else
		db WIDE_LENS, ABIL_GENGAR_LEVITATE | NAT_SATK_UP_ATK_DOWN
endc
		ev_spread 64 SAt, 64 Spe
	...
	; party
	dbp 71, CURSOLA, MALE
		db LEFTOVERS, ABIL_CURSOLA_PERISH_BODY | NAT_DEF_UP_ATK_DOWN
		db POWER_GEM, SHADOW_BALL, GIGA_DRAIN, CURSE
	dbp 72, GENGAR, MALE
		db WISE_GLASSES, ABIL_GENGAR_CURSED_BODY | NAT_SPE_UP_ATK_DOWN
		db WILL_O_WISP, HEX, FOCUS_BLAST, SUBSTITUTE
	dbp 73, NOCTOWL, MALE
		db SHARP_BEAK, ABIL_NOCTOWL_TINTED_LENS | NAT_SPE_UP_ATK_DOWN
		db MOONBLAST, AIR_SLASH, SHADOW_BALL, REFLECT
	dbp 70, NINETALES, MALE
		db CHARCOAL, ABIL_NINETALES_FLASH_FIRE | NAT_SATK_UP_ATK_DOWN
		db NASTY_PLOT, HEX, FLAMETHROWER, WILL_O_WISP
	dbp 74, GENGAR, MALE
if DEF(FAITHFUL)
		db SPELL_TAG, ABIL_GENGAR_CURSED_BODY | NAT_SATK_UP_ATK_DOWN
else
		db SPELL_TAG, ABIL_GENGAR_LEVITATE | NAT_SATK_UP_ATK_DOWN
endc
		db NASTY_PLOT, SHADOW_BALL, THUNDERBOLT, DESTINY_BOND
	dbp 75, MISMAGIUS, MALE
		db PINK_BOW, ABIL_MISMAGIUS_LEVITATE | NAT_SPE_UP_ATK_DOWN
...
endc
	...
	dbp 31, POLIWRATH, MALE
		db ZOOM_LENS, ABIL_POLIWRATH_WATER_ABSORB | NAT_ATK_UP_SATK_DOWN
		ev_spread 160 Atk
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 72, TAUROS, MALE | PALDEAN_FORM
		db QUICK_CLAW, ABIL_TAUROS_PALDEAN_INTIMIDATE | NAT_SDEF_UP_SATK_DOWN
		db CLOSE_COMBAT, BULK_UP, ZEN_HEADBUTT, EARTHQUAKE
	dbp 71, GRANBULL, MALE
		db TOXIC_ORB, ABIL_GRANBULL_QUICK_FEET | NAT_SPE_UP_SATK_DOWN
		db PLAY_ROUGH, CLOSE_COMBAT, FIRE_PUNCH, FACADE
	dbp 71, SIRFETCH_D, MALE
		db LEEK, ABIL_SIRFETCH_D_SCRAPPY | NAT_SPE_UP_SATK_DOWN
		db CLOSE_COMBAT, BRAVE_BIRD, NIGHT_SLASH, POWER_WHIP
	dbp 72, HITMONTOP, MALE
		db KINGS_ROCK, ABIL_HITMONTOP_INTIMIDATE | NAT_ATK_UP_SATK_DOWN
		db RAPID_SPIN, TOXIC, CLOSE_COMBAT, SUCKER_PUNCH
	dbp 73, ANNIHILAPE, MALE
		db DRAGON_FANG, ABIL_ANNIHILAPE_DEFIANT | NAT_DEF_UP_SATK_DOWN
...
JasmineGroup:
	...
	dbp 33, CORSOLA
		db NO_ITEM
		ev_spread 192 HP
		db BUBBLE_BEAM, ANCIENTPOWER, ROCK_BLAST, SAFEGUARD
	dbp 34, FORRETRESS
		db NO_ITEM
		ev_spread 192 HP
		db TOXIC_SPIKES, GYRO_BALL, DEFENSE_CURL, ROLLOUT
	dbp 33, MAGNETON
		db NO_ITEM
		ev_spread 192 HP
	...
	; party
	dbp 73, FORRETRESS, FEMALE
		db LOADED_DICE, FAKE_PERFECT_DVS, ABIL_FORRETRESS_STURDY | NAT_SDEF_UP_SATK_DOWN
		db PIN_MISSILE, GYRO_BALL, EXPLOSION, TOXIC_SPIKES
	dbp 74, CORSOLA, FEMALE
		db CHARCOAL, DVS_HP_FIRE, ABIL_CORSOLA_REGENERATOR | NAT_DEF_UP_ATK_DOWN
		db SURF, POWER_GEM, HIDDEN_POWER, RECOVER
	dbp 72, PERRSERKER, FEMALE
		db ASSAULT_VEST, FAKE_PERFECT_DVS, ABIL_PERRSERKER_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db CLOSE_COMBAT, NIGHT_SLASH, PLAY_ROUGH, IRON_HEAD
	dbp 72, SKARMORY, FEMALE
		db LEFTOVERS, FAKE_PERFECT_DVS, ABIL_SKARMORY_STURDY | NAT_SDEF_UP_SATK_DOWN
		db SPIKES, SCREECH, DRILL_PECK, STEEL_WING
if DEF(FAITHFUL)
	dbp 73, MAGNEZONE
		db MIRACLE_SEED, DVS_HP_GRASS, ABIL_MAGNEZONE_STURDY | NAT_SATK_UP_ATK_DOWN
		db THUNDERBOLT, HIDDEN_POWER, FLASH_CANNON, EXPLOSION
else
	dbp 73, MAGNEZONE
		db MYSTIC_WATER, DVS_HP_WATER, ABIL_MAGNEZONE_LEVITATE | NAT_SATK_UP_ATK_DOWN
		db THUNDERBOLT, HIDDEN_POWER, FLASH_CANNON, TRI_ATTACK
endc
	dbp 75, STEELIX, FEMALE
		db LIFE_ORB, FAKE_PERFECT_DVS, ABIL_STEELIX_SHEER_FORCE | NAT_ATK_UP_SATK_DOWN
...
PryceGroup:
	...
	dbp 38, DELIBIRD
		db WEAK_POLICY
		ev_spread 224 Spe
		db ICICLE_SPEAR, DRILL_PECK, FRESH_SNACK, ICE_SHARD
	dbp 40, MR__MIME, GALARIAN_FORM
		db NO_ITEM
		ev_spread 224 SAt
		db HYPNOSIS, PSYBEAM, ENCORE, ICE_BEAM
	dbp 42, MAMOSWINE
		db SITRUS_BERRY
		ev_spread 224 Atk
	...
	; party
if DEF(FAITHFUL)
	dbp 73, DELIBIRD, MALE
		db LIECHI_BERRY, FAKE_PERFECT_DVS, ABIL_DELIBIRD_HUSTLE | NAT_SPE_UP_SATK_DOWN
		db SPIKES, ICICLE_SPEAR, ACROBATICS, DESTINY_BOND
else
	dbp 73, DELIBIRD, MALE
		db LIECHI_BERRY, FAKE_PERFECT_DVS, ABIL_DELIBIRD_UNBURDEN | NAT_SPE_UP_SATK_DOWN
		db SPIKES, ICICLE_SPEAR, ACROBATICS, DESTINY_BOND
endc
	dbp 73, DEWGONG, FEMALE
		db ICY_ROCK, FAKE_PERFECT_DVS, ABIL_DEWGONG_ICE_BODY | NAT_SATK_UP_ATK_DOWN
		db HAIL, TOXIC, SURF, BLIZZARD
	dbp 72, WEAVILE, MALE
		db KINGS_ROCK, FAKE_PERFECT_DVS, ABIL_WEAVILE_PRESSURE | NAT_SPE_UP_SATK_DOWN
		db SWORDS_DANCE, ICICLE_CRASH, NIGHT_SLASH, POISON_JAB
	dbp 71, SANDSLASH, MALE | ALOLAN_FORM
		db NEVERMELTICE, FAKE_PERFECT_DVS, ABIL_SANDSLASH_ALOLAN_SLUSH_RUSH | NAT_ATK_UP_SATK_DOWN
		db IRON_HEAD, ICICLE_CRASH, ROCK_SLIDE, RAPID_SPIN
	dbp 73, MR__RIME, MALE
		db LEFTOVERS, FAKE_PERFECT_DVS, ABIL_MR__RIME_ICE_BODY | NAT_SATK_UP_ATK_DOWN
		db PSYCHIC_M, ICE_BEAM, THUNDERBOLT, HYPNOSIS
	dbp 75, MAMOSWINE, MALE
		db HARD_STONE, FAKE_PERFECT_DVS, ABIL_MAMOSWINE_THICK_FAT | NAT_ATK_UP_SATK_DOWN
...
ClairGroup:
	...
	dbp 47, KINGDRA, FEMALE
		db SHELL_BELL, ABIL_KINGDRA_SNIPER | NAT_SPE_UP_ATK_DOWN
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 70, GYARADOS, FEMALE
		db BRIGHTPOWDER, ABIL_GYARADOS_INTIMIDATE | NAT_SPE_UP_SATK_DOWN
		db DRAGON_DANCE, WATERFALL, FLY, EARTHQUAKE
	dbp 72, DRAGONAIR, FEMALE
		db LEFTOVERS, ABIL_DRAGONAIR_SHED_SKIN | NAT_ATK_UP_SATK_DOWN
		db OUTRAGE, DRAGON_DANCE, AQUA_TAIL, IRON_TAIL
	dbp 73, AMPHAROS, FEMALE
		db DRAGON_FANG, ABIL_AMPHAROS_MOLD_BREAKER | NAT_SATK_UP_ATK_DOWN
		db THUNDERBOLT, DRAGON_PULSE, DAZZLINGLEAM, THUNDER_WAVE
	dbp 72, LAPRAS, FEMALE
		db CLEAR_AMULET, ABIL_LAPRAS_SHELL_ARMOR | NAT_ATK_UP_SATK_DOWN
		db ICE_SHARD, WATERFALL, DRAGON_DANCE, OUTRAGE
	dbp 74, DRAGONAIR, FEMALE
		db EVIOLITE, ABIL_DRAGONAIR_MARVEL_SCALE | NAT_SPE_UP_SATK_DOWN
		db LIGHT_SCREEN, FLAMETHROWER, OUTRAGE, AQUA_TAIL
	dbp 75, KINGDRA, FEMALE
		db CHESTO_BERRY, ABIL_KINGDRA_SNIPER | NAT_ATK_UP_SATK_DOWN
...
WillGroup:
	...
	dbp 50, GIRAFARIG
		db EVIOLITE
		ev_spread 144 HP, 144 SAt
		db NASTY_PLOT, HYPER_VOICE, LIGHT_SCREEN, PSYCHIC_M
	dbp 49, SLOWBRO, GALARIAN_FORM
		db SITRUS_BERRY
		ev_spread 144 HP, 144 SDf
		db SLUDGE_BOMB, CALM_MIND, BODY_SLAM, PSYCHIC_M
	dbp 51, XATU
		db LEFTOVERS
	...
	; party
	dbp 67, WYRDEER, MALE
		db TWISTEDSPOON, FAKE_PERFECT_DVS, ABIL_WYRDEER_INTIMIDATE | NAT_ATK_UP_SATK_DOWN
		db SHADOW_BALL, MEGAHORN, EARTHQUAKE, PSYCHIC_M
	dbp 68, EXEGGUTOR, FEMALE
		db SITRUS_BERRY, FAKE_PERFECT_DVS, ABIL_EXEGGUTOR_HARVEST | NAT_ATK_UP_SATK_DOWN
		db REFLECT, GIGA_DRAIN, SLEEP_POWDER, PSYCHIC_M
	dbp 68, JYNX, FEMALE
		db BRIGHTPOWDER, FAKE_PERFECT_DVS, ABIL_JYNX_OBLIVIOUS | NAT_ATK_UP_SATK_DOWN
		db NASTY_PLOT, DRAINING_KISS, ICE_BEAM, PSYCHIC_M
	dbp 69, SLOWBRO, MALE | GALARIAN_FORM
		db QUICK_CLAW, FAKE_PERFECT_DVS, ABIL_SLOWBRO_GALARIAN_QUICK_DRAW | NAT_ATK_UP_SATK_DOWN
		db GUNK_SHOT, PSYCHIC_M, FLAMETHROWER, REST
	dbp 69, FARIGIRAF, FEMALE
		db SITRUS_BERRY, DVS_HP_FIRE, ABIL_FARIGIRAF_CUD_CHEW | NAT_ATK_UP_SATK_DOWN
		db HIDDEN_POWER, NASTY_PLOT, DARK_PULSE, PSYCHIC_M
	dbp 70, XATU, MALE
		db LEFTOVERS, DVS_HP_FIGHTING, ABIL_XATU_MAGIC_BOUNCE | NAT_ATK_UP_SATK_DOWN
		db HIDDEN_POWER, AIR_SLASH, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
KogaGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_MOVES
	; party
	dbp 50, QWILFISH, HISUIAN_FORM
		db EVIOLITE
		ev_spread 160 Def, 160 SDf
		db POISON_JAB, WATERFALL, CRUNCH, SPIKES
	dbp 50, VENOMOTH
		db LEFTOVERS
	...
	dbp 52, ARIADOS
		...
		db X_SCISSOR, POISON_JAB, SUCKER_PUNCH, TOXIC_SPIKES
	dbp 51, WEEZING
		db POISON_BARB
		ev_spread 252 HP, 68 Spe
		db WILL_O_WISP, SHADOW_BALL, SLUDGE_BOMB, EXPLOSION
	dbp 51, CROBAT
		db SCOPE_LENS
	...
	dbp 53, MUK
		db BRIGHTPOWDER
		ev_spread 252 Atk, 68 Spe
		db MINIMIZE, SCREECH, GUNK_SHOT, ICE_PUNCH
	db -1 ; end
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 69, OVERQWIL, MALE
		db LEFTOVERS, ABIL_OVERQWIL_POISON_POINT | NAT_SDEF_UP_SATK_DOWN
		db SPIKES, DESTINY_BOND, POISON_JAB, CRUNCH
	dbp 71, ARIADOS, MALE
		db MUSCLE_BAND, ABIL_ARIADOS_SNIPER | NAT_SPE_UP_SATK_DOWN
		db GLARE, LEECH_LIFE, NIGHT_SLASH, TOXIC_SPIKES
	dbp 69, ARBOK, MALE | ARBOK_KOGA_FORM
		db SOFT_SAND, ABIL_ARBOK_INTIMIDATE | NAT_ATK_UP_SATK_DOWN
		db POISON_JAB, GLARE, EARTHQUAKE, SCREECH
	dbp 70, WEEZING, MALE
		db WISE_GLASSES, ABIL_WEEZING_LEVITATE | NAT_SATK_UP_ATK_DOWN
		db WILL_O_WISP, THUNDER, SLUDGE_BOMB, EXPLOSION
	dbp 71, CROBAT, MALE
		db SCOPE_LENS, ABIL_CROBAT_INFILTRATOR | NAT_SPE_UP_SATK_DOWN
		db SCREECH, TOXIC, CRUNCH, AERIAL_ACE
	dbp 72, MUK, MALE
		db BRIGHTPOWDER, ABIL_MUK_POISON_TOUCH | NAT_ATK_UP_SATK_DOWN
...
BrunoGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 70, TAUROS, MALE | TAUROS_PALDEAN_WATER_FORM
		db SITRUS_BERRY, ABIL_TAUROS_PALDEAN_WATER_CUD_CHEW | NAT_ATK_UP_SATK_DOWN
		db BULK_UP, ZEN_HEADBUTT, AQUA_TAIL, CLOSE_COMBAT
	dbp 71, SNEASLER, MALE
		db FOCUS_SASH, ABIL_SNEASLER_UNBURDEN | NAT_SPE_UP_SATK_DOWN
		db SWORDS_DANCE, X_SCISSOR, DRAIN_PUNCH, GUNK_SHOT
	dbp 70, HITMONCHAN, MALE
		db MUSCLE_BAND, ABIL_HITMONCHAN_IRON_FIST | NAT_ATK_UP_SATK_DOWN
		db THUNDERPUNCH, ICE_PUNCH, DRAIN_PUNCH, BULLET_PUNCH
	dbp 70, HITMONLEE, MALE
		db SALAC_BERRY, ABIL_HITMONLEE_UNBURDEN | NAT_SPE_UP_SATK_DOWN
		db ROCK_SLIDE, SUCKER_PUNCH, HI_JUMP_KICK, REVERSAL
	dbp 72, STEELIX, MALE
		db LEFTOVERS, ABIL_STEELIX_STURDY | NAT_DEF_UP_SATK_DOWN
		db CURSE, EARTHQUAKE, STONE_EDGE, IRON_HEAD
	dbp 74, MACHAMP, MALE
		db FLAME_ORB, ABIL_MACHAMP_GUTS | NAT_ATK_UP_SATK_DOWN
		db MACH_PUNCH, STONE_EDGE, FACADE, CROSS_CHOP
	db -1 ; end
...
KarenGroup:
	...
	; party
if DEF(FAITHFUL)
	dbp 71, UMBREON, FEMALE
		db LEFTOVERS, ABIL_UMBREON_SYNCHRONIZE | NAT_NEUTRAL
		db CHARM, HEALINGLIGHT, PURSUIT, TOXIC
else
	dbp 71, UMBREON, FEMALE
		db LEFTOVERS, ABIL_UMBREON_MAGIC_GUARD | NAT_NEUTRAL
		db CHARM, HEALINGLIGHT, PURSUIT, TOXIC
endc
	dbp 73, PERSIAN, FEMALE | ALOLAN_FORM
		db PINK_BOW, ABIL_PERSIAN_ALOLAN_FUR_COAT | NAT_NEUTRAL
		db DARK_PULSE, POWER_GEM, BUBBLE_BEAM, HYPNOSIS
if DEF(FAITHFUL)
	dbp 72, WEAVILE, FEMALE
		db KINGS_ROCK, ABIL_WEAVILE_PRESSURE | NAT_SPE_UP_SATK_DOWN
		db SWORDS_DANCE, SCREECH, NIGHT_SLASH, ICE_PUNCH
else
	dbp 72, WEAVILE, FEMALE
		db KINGS_ROCK, ABIL_WEAVILE_TECHNICIAN | NAT_SPE_UP_SATK_DOWN
		db SWORDS_DANCE, METAL_CLAW, FEINT_ATTACK, ICICLE_SPEAR
endc
	dbp 74, GENGAR, FEMALE
		db MAGNET, ABIL_GENGAR_SHADOW_TAG | NAT_SPE_UP_SATK_DOWN
		db HYPNOSIS, SLUDGE_BOMB, SHADOW_BALL, DESTINY_BOND
	dbp 74, HONCHKROW, FEMALE
		db BLACKGLASSES, ABIL_HONCHKROW_SUPER_LUCK | NAT_SPE_UP_SATK_DOWN
		db DRILL_PECK, SUCKER_PUNCH, NIGHT_SLASH, STEEL_WING
	dbp 76, HOUNDOOM, FEMALE
		db WISE_GLASSES, ABIL_HOUNDOOM_FLASH_FIRE | NAT_SPE_UP_SATK_DOWN
...
ChampionGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 57, GYARADOS, MALE | GYARADOS_RED_FORM
	...
	dbp 58, TYRANITAR, MALE
		db SCOPE_LENS, ABIL_TYRANITAR_UNNERVE | NAT_SATK_UP_ATK_DOWN
		ev_spread 252 Atk, 164 Def
		db EARTHQUAKE, CRUNCH, ROCK_SLIDE, PURSUIT
...
endc
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 75, GYARADOS, MALE | GYARADOS_RED_FORM
		db LIFE_ORB, ABIL_GYARADOS_INTIMIDATE | NAT_SPE_UP_SATK_DOWN
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
if DEF(FAITHFUL)
...
endc
	dbp 77, TYRANITAR, MALE
		db ASSAULT_VEST, ABIL_TYRANITAR_UNNERVE | NAT_SATK_UP_ATK_DOWN
		db STONE_EDGE, CRUNCH, THUNDERPUNCH, IRON_HEAD
	...
	dbp 77, EXEGGUTOR, MALE | ALOLAN_FORM
		db LUM_BERRY, ABIL_EXEGGUTOR_ALOLAN_HARVEST | NAT_SATK_UP_SPE_DOWN
if DEF(FAITHFUL)
		db GIGA_DRAIN, DRAGON_PULSE, FLAMETHROWER, SLUDGE_BOMB
else
		db GIGA_DRAIN, OUTRAGE, FLAMETHROWER, IRON_HEAD
endc
...
BrockGroup:
	...
	dbp 65, KABUTOPS
		...
		db SLASH, WATERFALL, ENDURE, GIGA_DRAIN
	dbp 65, OMASTAR
		db NO_ITEM
	...
	dbp 63, SUDOWOODO
		...
		db SUBSTITUTE, ROCK_SLIDE, LOW_KICK, SPIKES
	dbp 68, ONIX
		db EVIOLITE
	...
	; party
	dbp 74, ONIX, MALE
		db EVIOLITE, ABIL_ONIX_STURDY | NAT_SPE_UP_SATK_DOWN
		db IRON_HEAD, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
	dbp 72, KABUTOPS, MALE
		db SILVERPOWDER, ABIL_KABUTOPS_BATTLE_ARMOR | NAT_ATK_UP_SATK_DOWN
		db NIGHT_SLASH, WATERFALL, LEECH_LIFE, SHELL_SMASH
	dbp 73, RHYPERIOR, MALE
		db KINGS_ROCK, ABIL_RHYPERIOR_SOLID_ROCK | NAT_SDEF_UP_SATK_DOWN
		db AVALANCHE, ROCK_SLIDE, IRON_HEAD, MEGAHORN
	dbp 72, OMASTAR, MALE
		db MYSTIC_WATER, ABIL_OMASTAR_SHELL_ARMOR | NAT_SATK_UP_ATK_DOWN
		db POWER_GEM, SURF, EARTH_POWER, TOXIC_SPIKES
	dbp 73, SUDOWOODO, MALE
		db ASSAULT_VEST, ABIL_SUDOWOODO_STURDY | NAT_SDEF_UP_SATK_DOWN
		db STONE_EDGE, ROCK_SMASH, SUCKER_PUNCH, THUNDERPUNCH
	dbp 75, GOLEM, MALE
		db LEFTOVERS, ABIL_GOLEM_STURDY | NAT_ATK_UP_SATK_DOWN
		db GYRO_BALL, BODY_SLAM, STONE_EDGE, EARTHQUAKE
	db -1 ; end
...
MistyGroup:
	...
	dbp 61, GOLDUCK
		...
		db WATER_PULSE, RAIN_DANCE, CALM_MIND, PSYCHIC_M
	dbp 60, KINGLER
		db NO_ITEM
	...
	dbp 62, QUAGSIRE
		db NO_ITEM
		ev_spread 100 HP, 252 SAt
		db SCALD, CALM_MIND, EARTHQUAKE, RECOVER
	dbp 64, STARMIE
		db SITRUS_BERRY
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 73, POLITOED, MALE
		db DAMP_ROCK, ABIL_POLITOED_DRIZZLE | NAT_SATK_UP_ATK_DOWN
		db ENERGY_BALL, SCALD, ICE_BEAM, HYPNOSIS
	dbp 72, GOLDUCK, MALE
		db TWISTEDSPOON, ABIL_GOLDUCK_SWIFT_SWIM | NAT_SATK_UP_ATK_DOWN
		db PSYCHIC_M, SCALD, ICE_BEAM, CALM_MIND
	dbp 73, QUAGSIRE, FEMALE
		db LEFTOVERS, ABIL_QUAGSIRE_UNAWARE | NAT_SATK_UP_ATK_DOWN
		db EARTHQUAKE, AQUA_TAIL, RECOVER, TOXIC
	dbp 72, OCTILLERY, FEMALE
		db CHARCOAL, ABIL_OCTILLERY_SNIPER | NAT_SATK_UP_ATK_DOWN
		db FIRE_BLAST, ICE_BEAM, OCTAZOOKA, POWER_WHIP
	dbp 74, SEAKING, FEMALE
		db KINGS_ROCK, ABIL_SEAKING_SWIFT_SWIM | NAT_ATK_UP_SATK_DOWN
		db AGILITY, WATERFALL, MEGAHORN, KNOCK_OFF
	dbp 75, STARMIE, FEMALE
		db LEFTOVERS, ABIL_STARMIE_NATURAL_CURE | NAT_SATK_UP_ATK_DOWN
...
LtSurgeGroup:
	...
	dbp 57, ELECTRODE
		...
		db SCREECH, LIGHT_SCREEN, THUNDERBOLT, EXPLOSION
	dbp 56, MAGNEZONE
		db NO_ITEM
		ev_spread 36 HP, 252 SAt
		db REFLECT, DOUBLE_TEAM, FLASH_CANNON, ZAP_CANNON
	dbp 58, ELECTABUZZ
		db EVIOLITE
		ev_spread 252 HP, 36 Def
		db QUICK_ATTACK, THUNDERPUNCH, ICE_PUNCH, ROCK_SMASH
	dbp 60, RAICHU
		db SITRUS_BERRY
		ev_spread 36 Atk, 252 SAt
		db THUNDER_WAVE, EXTREMESPEED, SURF, THUNDER
	db -1 ; end
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 72, ELECTRODE, MALE
		db LIGHT_CLAY, DVS_HP_ICE, ABIL_ELECTRODE_AFTERMATH | NAT_SPE_UP_ATK_DOWN
		db REFLECT, DOUBLE_TEAM, HIDDEN_POWER, THUNDER
	dbp 73, GOLEM, MALE | ALOLAN_FORM
		db ZOOM_LENS, FAKE_PERFECT_DVS, ABIL_GOLEM_ALOLAN_GALVANIZE | NAT_ATK_UP_SATK_DOWN
		db STONE_EDGE, WILD_CHARGE, GYRO_BALL, EXPLOSION
if DEF(FAITHFUL)
	dbp 72, MAGNEZONE, MALE
		db CHARCOAL, DVS_HP_FIRE, ABIL_MAGNEZONE_STURDY | NAT_DEF_UP_ATK_DOWN
		db LIGHT_SCREEN, DOUBLE_TEAM, HIDDEN_POWER, THUNDERBOLT
else
	dbp 72, MAGNEZONE, MALE
		db CHARCOAL, DVS_HP_FIRE, ABIL_MAGNEZONE_LEVITATE | NAT_DEF_UP_ATK_DOWN
		db LIGHT_SCREEN, DOUBLE_TEAM, HIDDEN_POWER, THUNDERBOLT
endc
	dbp 73, LANTURN, MALE
		db LEFTOVERS, FAKE_PERFECT_DVS, ABIL_LANTURN_WATER_ABSORB | NAT_SDEF_UP_ATK_DOWN
		db SURF, RAIN_DANCE, THUNDER, RECOVER
	dbp 74, ELECTIVIRE, MALE
		db PUNCHINGLOVE, FAKE_PERFECT_DVS, ABIL_ELECTIVIRE_MOTOR_DRIVE | NAT_ATK_UP_SATK_DOWN
		db CROSS_CHOP, ICE_PUNCH, STRENGTH, THUNDERPUNCH
	dbp 75, RAICHU, MALE
		db BRIGHTPOWDER, FAKE_PERFECT_DVS, ABIL_RAICHU_LIGHTNING_ROD | NAT_SPE_UP_ATK_DOWN
		db SURF, NASTY_PLOT, THUNDERBOLT, FOCUS_BLAST
	db -1 ; end
...
ErikaGroup:
	...
	dbp 61, JUMPLUFF
		db NO_ITEM
		ev_spread 192 SAt, 192 Spe
		db GIGA_DRAIN, ACROBATICS, SLEEP_POWDER, HEALINGLIGHT
	dbp 62, TANGELA
		db EVIOLITE
	...
	dbp 64, VICTREEBEL
		...
		db SUNNY_DAY, HEALINGLIGHT, POISON_JAB, RAZOR_LEAF
	dbp 65, VILEPLUME
		db NO_ITEM
		ev_spread 252 SAt, 132 Spe
		db SUNNY_DAY, HEALINGLIGHT, PETAL_DANCE, SLUDGE_BOMB
	dbp 65, BELLOSSOM
		db SITRUS_BERRY
		ev_spread 132 SAt, 252 Spe
		db SOLAR_BEAM, HEALINGLIGHT, PETAL_DANCE, DAZZLING_GLEAM
	db -1 ; end
	...
	; party
	dbp 72, SUNFLORA
		db HEAT_ROCK, FAKE_PERFECT_DVS, ABIL_SUNFLORA_SOLAR_POWER | NAT_SATK_UP_ATK_DOWN
if DEF(FAITHFUL)
...
endc
	dbp 73, TANGROWTH
		db MIRACLE_SEED, FAKE_PERFECT_DVS, ABIL_TANGROWTH_REGENERATOR | NAT_ATK_UP_SATK_DOWN
		db EARTHQUAKE, SWORDS_DANCE, POWER_WHIP, ANCIENTPOWER
	dbp 74, JUMPLUFF
		db LEFTOVERS, FAKE_PERFECT_DVS, ABIL_JUMPLUFF_INFILTRATOR | NAT_SPE_UP_SATK_DOWN
		db ENCORE, LEECH_SEED, SLEEP_POWDER, U_TURN
	dbp 73, VICTREEBEL
		db POISON_BARB, FAKE_PERFECT_DVS, ABIL_VICTREEBEL_CHLOROPHYLL | NAT_SPE_UP_SATK_DOWN
		db SWORDS_DANCE, LEECH_LIFE, SUCKER_PUNCH, SEED_BOMB
	dbp 74, VILEPLUME
		db QUICK_CLAW, FAKE_PERFECT_DVS, ABIL_VILEPLUME_EFFECT_SPORE | NAT_SDEF_UP_ATK_DOWN
		db PETAL_DANCE, HEALINGLIGHT, VENOSHOCK, TOXIC
	dbp 75, BELLOSSOM
		db PINK_BOW, DVS_HP_ROCK, ABIL_BELLOSSOM_CHLOROPHYLL | NAT_SATK_UP_ATK_DOWN
...
JanineGroup:
	...
	dbp 62, TENTACRUEL
		...
		db TOXIC, SURF, SLUDGE_BOMB, ICE_BEAM
	dbp 64, SNEASLER
		db KINGS_ROCK
		ev_spread 252 HP, 164 Atk
		db ROCK_SMASH, POISON_JAB, METAL_CLAW, HONE_CLAWS
	dbp 66, VENOMOTH
		db SITRUS_BERRY
		ev_spread 208 SAt, 208 Spe
		db SLUDGE_BOMB, DOUBLE_TEAM, LEECH_LIFE, PSYCHIC_M
	db -1 ; end
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 73, QWILFISH, FEMALE
		db QUICK_CLAW, ABIL_QWILFISH_INTIMIDATE | NAT_SDEF_UP_ATK_DOWN
		db AQUA_TAIL, DESTINY_BOND, TOXIC_SPIKES, SPIKES
	dbp 72, CROBAT, FEMALE
		db KINGS_ROCK, ABIL_CROBAT_INFILTRATOR | NAT_SPE_UP_SATK_DOWN
		db DOUBLE_TEAM, POISON_JAB, AERIAL_ACE, TOXIC
	dbp 72, WEEZING, FEMALE
		db CHARCOAL, ABIL_WEEZING_LEVITATE | NAT_SATK_UP_ATK_DOWN
		db SLUDGE_BOMB, FIRE_BLAST, WILL_O_WISP, EXPLOSION
	dbp 74, CLODSIRE, FEMALE
		db LEFTOVERS, ABIL_CLODSIRE_WATER_ABSORB | NAT_SDEF_UP_ATK_DOWN
		db GUNK_SHOT, MEGAHORN, EARTHQUAKE, TOXIC_SPIKES
	dbp 73, SNEASLER, FEMALE
		db FOCUS_BAND, ABIL_SNEASLER_POISON_TOUCH | NAT_ATK_UP_SATK_DOWN
		db CLOSE_COMBAT, ICE_PUNCH, SHADOW_CLAW, SWORDS_DANCE
	dbp 75, VENOMOTH, FEMALE
		db BRIGHTPOWDER, ABIL_VENOMOTH_TINTED_LENS | NAT_SATK_UP_ATK_DOWN
		db BUG_BUZZ, SLUDGE_BOMB, SLEEP_POWDER, DREAM_EATER
	db -1 ; end
...
SabrinaGroup:
	...
	dbp 60, MR__MIME
		db LIGHT_CLAY
		ev_spread 252 HP, 68 Spe
		db LIGHT_SCREEN, REFLECT, BATON_PASS, DAZZLINGLEAM
	dbp 61, ESPEON
		db NO_ITEM
		ev_spread 252 SAt, 68 Spe
		db MUD_SLAP, QUICK_ATTACK, POWER_GEM, EXTRASENSORY 
	dbp 59, WOBBUFFET
		db NO_ITEM
		ev_spread 252 HP, 68 Spe
	...
	dbp 60, HYPNO
		...
		db HYPNOSIS, DREAM_EATER, FIRE_PUNCH, ZEN_HEADBUTT
	dbp 62, ALAKAZAM
		db SITRUS_BERRY
		ev_spread 252 SAt, 68 Spe
	...
	dbp 73, MR__MIME, FEMALE
		db LIGHT_CLAY, FAKE_PERFECT_DVS, ABIL_MR__MIME_FILTER | NAT_DEF_UP_ATK_DOWN
		db PSYCHIC_M, DAZZLINGLEAM, REFLECT, ENCORE
	dbp 74, BUTTERFREE, FEMALE
		db BRIGHTPOWDER, FAKE_PERFECT_DVS, ABIL_BUTTERFREE_COMPOUND_EYES | NAT_SATK_UP_ATK_DOWN
		db PSYCHIC_M, SHADOW_BALL, BUG_BUZZ, SLEEP_POWDER
	dbp 73, ESPEON, FEMALE
		db LEFTOVERS, DVS_HP_FIRE, ABIL_ESPEON_MAGIC_BOUNCE | NAT_SPE_UP_ATK_DOWN
		db PSYCHIC_M, BATON_PASS, HIDDEN_POWER, LIGHT_SCREEN
	dbp 72, HYPNO, FEMALE
		db TWISTEDSPOON, FAKE_PERFECT_DVS, ABIL_HYPNO_INNER_FOCUS | NAT_ATK_UP_SATK_DOWN
		db HYPNOSIS, ZEN_HEADBUTT, DRAIN_PUNCH, FIRE_PUNCH
	dbp 74, SLOWKING, FEMALE
		db KINGS_ROCK, FAKE_PERFECT_DVS, ABIL_SLOWKING_REGENERATOR | NAT_DEF_UP_ATK_DOWN
		db THUNDER_WAVE, NASTY_PLOT, SCALD, PSYCHIC_M
	dbp 75, ALAKAZAM, FEMALE
		db LIFE_ORB, DVS_HP_FIGHTING, ABIL_ALAKAZAM_MAGIC_GUARD | NAT_SPE_UP_ATK_DOWN
		db RECOVER, SHADOW_BALL, PSYCHIC_M, HIDDEN_POWER
	db -1 ; end
...
BlaineGroup:
	...
	dbp 65, RAPIDASH
		...
		db QUICK_ATTACK, FIRE_SPIN, PLAY_ROUGH, FLAME_CHARGE
	dbp 68, MAGMAR
		db EVIOLITE
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	dbp 71, NINETALES, MALE
		db HEAT_ROCK, ABIL_NINETALES_DROUGHT | NAT_SATK_UP_ATK_DOWN
		db NASTY_PLOT, FLAMETHROWER, SOLAR_BEAM, SHADOW_BALL
	dbp 72, TAUROS, MALE | TAUROS_PALDEAN_FIRE_FORM
		db SITRUS_BERRY, ABIL_TAUROS_PALDEAN_FIRE_CUD_CHEW | NAT_ATK_UP_SATK_DOWN
		db BULK_UP, ZEN_HEADBUTT, FLARE_BLITZ, CLOSE_COMBAT
	dbp 74, MAGCARGO, MALE
		db WHITE_HERB, ABIL_MAGCARGO_FLAME_BODY | NAT_SDEF_UP_ATK_DOWN
		db RECOVER, SHELL_SMASH, POWER_GEM, FLAMETHROWER
	dbp 72, RAPIDASH, MALE
		db POISON_BARB, ABIL_RAPIDASH_FLAME_BODY | NAT_SPE_UP_SATK_DOWN
		db PLAY_ROUGH, POISON_JAB, FLARE_BLITZ, WILD_CHARGE
	dbp 74, MAGMORTAR, MALE
		db BLACK_BELT, ABIL_MAGMORTAR_FLAME_BODY | NAT_SATK_UP_ATK_DOWN
		db SUNNY_DAY, FOCUS_BLAST, FIRE_BLAST, THUNDERBOLT
	dbp 75, ARCANINE, MALE
		db KINGS_ROCK, ABIL_ARCANINE_INTIMIDATE | NAT_ATK_UP_SATK_DOWN
		db OUTRAGE, DRAGON_DANCE, FLARE_BLITZ, EXTREMESPEED
	db -1 ; end
...
Lyra1Group:
	...
	; LYRA1
	db "Lyra@"
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_NICKNAME
	; party
	dbp 16, PIDGEY, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Tweety@"
		ev_spread 36 HP, 36 Spe
	dbp 17, GROWLITHE, FEMALE | HISUIAN_FORM
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Archy@"
		ev_spread 36 HP, 36 Atk
	dbp 15, MAREEP, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db NO_ITEM, "Amphary@"
		ev_spread 36 HP, 36 SAt
	dbp 18, CROCONAW, FEMALE
		db ORAN_BERRY, ABILITY_1 | NAT_NEUTRAL, "Toto@"
		ev_spread 72 Atk
	db -1 ; end
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_NICKNAME
	; party
	dbp 33, PIDGEOTTO, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Tweety@"
		ev_spread 100 HP, 100 Spe
	dbp 34, GROWLITHE, FEMALE | HISUIAN_FORM
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Archy@"
		ev_spread 100 HP, 100 Atk
	dbp 34, AZUMARILL, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Bubbles@"
		ev_spread 200 Atk
	dbp 32, FLAAFFY, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Amphary@"
		ev_spread 100 HP, 100 SAt
	dbp 37, BAYLEEF, FEMALE
		db ORAN_BERRY, ABILITY_1 | NAT_NEUTRAL, "Chicory@"
		ev_spread 200 HP
	db -1 ; end
	...
	dbp 33, PIDGEOTTO, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Tweety@"
		ev_spread 100 HP, 100 Spe
	dbp 34, SUNFLORA, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Sunbo@"
		ev_spread 100 SAt, 100 Spe
	dbp 34, GROWLITHE, FEMALE | HISUIAN_FORM
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Archy@"
		ev_spread 100 HP, 100 Atk
	dbp 32, FLAAFFY, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Amphary@"
		ev_spread 100 HP, 100 SAt
	dbp 37, CROCONAW, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db ORAN_BERRY, "Toto@"
		ev_spread 200 Atk
	db -1 ; end
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_NICKNAME
	; party
	dbp 44, PIDGEOT, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Tweety@"
		ev_spread 132 HP, 132 Spe
	dbp 43, GIRAFARIG, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Gigi@"
		ev_spread 132 Atk, 132 Spe
	dbp 45, ARCANINE, FEMALE | HISUIAN_FORM
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Archy@"
		ev_spread 132 HP, 132 Atk
	dbp 45, AZUMARILL, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Bubbles@"
		ev_spread 252 Atk, 12 Spe
	dbp 46, AMPHAROS, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Amphary@"
		ev_spread 132 HP, 132 SAt
	dbp 47, MEGANIUM, FEMALE
		db SITRUS_BERRY, ABILITY_1 | NAT_NEUTRAL, "Chicory@"
	...
	dbp 46, AMPHAROS, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL, "Amphary@"
		ev_spread 132 HP, 132 SAt
	dbp 47, FERALIGATR, FEMALE
		db SITRUS_BERRY, ABILITY_1 | NAT_NEUTRAL, "Toto@"
		ev_spread 252 Atk, 12 Spe
	db -1 ; end
...
FisherGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 21, QWILFISH
	dbp LEVEL_FROM_BADGES + 23, LANTURN
	dbp LEVEL_FROM_BADGES + 22, GYARADOS
	db -1 ; end
...
HikerGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 19, CLEFABLE
	dbp LEVEL_FROM_BADGES + 17, SCYTHER
	dbp LEVEL_FROM_BADGES + 18, MACHOKE
	db -1 ; end
...
BeautyGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 16, SNUBBULL
	dbp LEVEL_FROM_BADGES + 19, GRANBULL
	dbp LEVEL_FROM_BADGES + 16, JIGGLYPUFF
	dbp LEVEL_FROM_BADGES + 18, SUNFLORA
	db -1 ; end
...
BugManiacGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 18, YANMA
	dbp LEVEL_FROM_BADGES + 18, YANMA
	dbp LEVEL_FROM_BADGES + 20, YANMEGA
	db -1 ; end
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 19, LEDIAN
	dbp LEVEL_FROM_BADGES + 19, BUTTERFREE
	db -1 ; end
...
FirebreatherGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 21, WEEZING
	dbp LEVEL_FROM_BADGES + 22, MAGMORTAR
	db -1 ; end
...
BreederGroup:
	...
	dbp LEVEL_FROM_BADGES + 19, CLEFABLE
		db PINK_BOW
	dbp LEVEL_FROM_BADGES + 18, WIGGLYTUFF
		db SITRUS_BERRY
	dbp LEVEL_FROM_BADGES + 20, SNORLAX
		db LEFTOVERS
	db -1 ; end
...
SwimmerMGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 24, POLITOED
	dbp LEVEL_FROM_BADGES + 24, POLIWRATH
	db -1 ; end
...
SwimmerFGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 17, REMORAID
	dbp LEVEL_FROM_BADGES + 17, REMORAID
	dbp LEVEL_FROM_BADGES + 17, REMORAID
	dbp LEVEL_FROM_BADGES + 19, MANTINE
	db -1 ; end
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 23, GOLDUCK
	dbp LEVEL_FROM_BADGES + 22, LANTURN
	dbp LEVEL_FROM_BADGES + 23, GYARADOS
	db -1 ; end
...
GuitaristMGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 22, MAGNEZONE
	db -1 ; end
	...
	; TODD: party
	dbp LEVEL_FROM_BADGES + 22, ELECTRODE
	db -1 ; end
...
GuitaristFGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 24, ELECTIVIRE
	db -1 ; end
...
TamerGroup:
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 18, KANGASKHAN
	dbp LEVEL_FROM_BADGES + 20, DONPHAN
	db -1 ; end
	...
	; party
	dbp LEVEL_FROM_BADGES + 20, DONPHAN
	dbp LEVEL_FROM_BADGES + 22, URSARING
	dbp LEVEL_FROM_BADGES + 21, KANGASKHAN
	db -1 ; end
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 18, URSARING
	dbp LEVEL_FROM_BADGES + 19, SKARMORY
	dbp LEVEL_FROM_BADGES + 20, ARBOK, ARBOK_KANTO_FORM
	db -1 ; end
...
ArtistGroup:
	...
	dbp LEVEL_FROM_BADGES + 19, SMEARGLE
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	dbp LEVEL_FROM_BADGES + 24, SMEARGLE
...
AromaLadyGroup:
	...
	db TRAINERTYPE_MOVES
	; party
	dbp LEVEL_FROM_BADGES + 19, BELLOSSOM
		db MOONBLAST, HYPER_VOICE, SLEEP_POWDER, GROWTH
	dbp LEVEL_FROM_BADGES + 20, SUNFLORA
		db SOLAR_BEAM, SUNNY_DAY, LEECH_SEED, SEED_BOMB
	dbp LEVEL_FROM_BADGES + 21, VICTREEBEL
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES -1, CHIKORITA
	dbp LEVEL_FROM_BADGES + 9, BAYLEEF
	dbp LEVEL_FROM_BADGES + 19, MEGANIUM
	db -1 ; end
	...
	db TRAINERTYPE_NORMAL
	; party
	dbp LEVEL_FROM_BADGES + 22, SUNFLORA
	dbp LEVEL_FROM_BADGES + 23, JUMPLUFF
	dbp LEVEL_FROM_BADGES + 24, VILEPLUME
	db -1 ; end
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 30, BELLOSSOM, FEMALE
...
SightseerMGroup:
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 20, MR__MIME
	dbp LEVEL_FROM_BADGES + 21, MR__MIME, GALARIAN_FORM
	dbp LEVEL_FROM_BADGES + 22, MR__RIME
	db -1 ; end
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 22, SUDOWOODO, MALE
		db ABILITY_1 | NAT_NEUTRAL, "Simularbre@"
	dbp LEVEL_FROM_BADGES + 22, EXEGGUTOR, MALE
		db ABILITY_1 | NAT_NEUTRAL, "Noadkoko@"
	dbp LEVEL_FROM_BADGES + 23, LEDIAN, MALE
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 23, DELIBIRD
	dbp LEVEL_FROM_BADGES + 24, DUDUNSPARCE, DUDUNSPARCE_THREE_SEGMENT_FORM
	db -1 ; end
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 20, FERALIGATR, MALE
		db LIFE_ORB, FAKE_PERFECT_DVS, ABIL_FERALIGATR_SHEER_FORCE | NAT_SPE_UP_SATK_DOWN
		db WATERFALL, CRUNCH, ICE_PUNCH, DRAGON_DANCE
	dbp LEVEL_FROM_BADGES + 20, TOGEKISS, FEMALE
	...
	dbp LEVEL_FROM_BADGES + 20, VAPOREON, MALE
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 22, PORYGON
	dbp LEVEL_FROM_BADGES + 23, PORYGON2
	dbp LEVEL_FROM_BADGES + 24, PORYGON_Z
	db -1 ; end
...
SightseerFGroup:
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 21, MEOWTH
	dbp LEVEL_FROM_BADGES + 22, MEOWTH, ALOLAN_FORM
	dbp LEVEL_FROM_BADGES + 23, MEOWTH, GALARIAN_FORM
	db -1 ; end
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 16, PERSIAN, ALOLAN_FORM
	dbp LEVEL_FROM_BADGES + 15, SANDSLASH, ALOLAN_FORM
	dbp LEVEL_FROM_BADGES + 15, DUGTRIO, ALOLAN_FORM
	dbp LEVEL_FROM_BADGES + 16, NINETALES, ALOLAN_FORM
	dbp LEVEL_FROM_BADGES + 15, RATICATE, ALOLAN_FORM
	dbp LEVEL_FROM_BADGES + 19, RAICHU, ALOLAN_FORM
	db -1 ; end
	...
	; TODO: party
	dbp LEVEL_FROM_BADGES + 19, CLEFABLE
	dbp LEVEL_FROM_BADGES + 21, GENGAR
	db -1 ; end
	...
	db TRAINERTYPE_PERSONALITY | TRAINERTYPE_NICKNAME
	; party
	dbp LEVEL_FROM_BADGES + 20, MAGBY, FEMALE
		db ABILITY_1 | NAT_NEUTRAL, "Antorcha@"
	dbp LEVEL_FROM_BADGES + 21, CUBONE, MALE
		db ABILITY_1 | NAT_NEUTRAL, "Huesitos@"
	dbp LEVEL_FROM_BADGES + 24, ESPEON, FEMALE
		db ABILITY_1 | NAT_NEUTRAL, "Luna@"
	dbp LEVEL_FROM_BADGES + 25, LANTURN, FEMALE
...
SightseersGroup:
	...
	db TRAINERTYPE_PERSONALITY
	; party
	dbp LEVEL_FROM_BADGES + 24, MR__MIME, MALE
		db ABILITY_1 | NAT_NEUTRAL
	dbp LEVEL_FROM_BADGES + 24, JYNX, FEMALE
		db ABILITY_1 | NAT_NEUTRAL
	db -1 ; end
...
PetrelGroup:
	...
	dbp 41, WEEZING, MALE | GALARIAN_FORM
		db SILK_SCARF, ABILITY_1 | NAT_NEUTRAL
		db PLAY_ROUGH, EXPLOSION, VENOSHOCK, SMOKESCREEN
	...
	dbp 36, WEEZING, MALE | GALARIAN_FORM
		db POISON_BARB, ABILITY_1 | NAT_NEUTRAL
		ev_spread 108 Atk, 108 SAt
		db PLAY_ROUGH, WILL_O_WISP, SLUDGE_BOMB, EXPLOSION
	db -1 ; end
...
LoreleiGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 39, GLACEON, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 240 Spe
		db ICE_BEAM, BARRIER, RECOVER, QUICK_ATTACK
	dbp 41, SANDSLASH, FEMALE | ALOLAN_FORM
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 240 Atk
		db IRON_HEAD, ICICLE_SPEAR, ROLLOUT, DEFENSE_CURL
	dbp 40, CLOYSTER, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 240 HP
		db DEFENSE_CURL, ROLLOUT, AURORA_BEAM, EXPLOSION
	dbp 41, SLOWBRO, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 240 HP
		db PSYCHIC_M, WATER_PULSE, HEADBUTT, DISABLE
	dbp 44, JYNX, FEMALE
		db SITRUS_BERRY, ABILITY_1 | NAT_NEUTRAL
		ev_spread 240 SAt
		db DRAINING_KISS, SING, AVALANCHE, PETAL_DANCE
	dbp 43, LAPRAS, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 58, SANDSLASH, FEMALE | ALOLAN_FORM
		db LEFTOVERS, ABILITY_1 | NAT_NEUTRAL
		ev_spread 160 Atk, 160 SDf
		db IRON_HEAD, ICICLE_CRASH, HAIL, SWORDS_DANCE
	dbp 57, CLOYSTER, FEMALE
		db SILK_SCARF, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 Atk, 68 Spe
		db EXPLOSION, ROLLOUT, ICICLE_CRASH, BARRIER
	dbp 58, SLOWBRO, FEMALE
		db TWISTEDSPOON, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 HP, 68 SAt
		db PSYCHIC_M, SURF, ICE_BEAM, CALM_MIND
	dbp 56, GLACEON, FEMALE
		db NEVERMELTICE, ABILITY_1 | NAT_NEUTRAL
...
StevenGroup:
	...
	dbp 77, KLEAVOR, MALE
		...
		db LEECH_LIFE, STONE_EDGE, CLOSE_COMBAT, SWORDS_DANCE
...
CynthiaGroup:
	...
	; party
	dbp 60, TOGEKISS
		db WISE_GLASSES, SHINY_MASK
		db AIR_SLASH, AURA_SPHERE, FRESH_SNACK, NASTY_PLOT
	dbp 58, LEAFEON
		db FOCUS_BAND
		db SWORDS_DANCE, SEED_BOMB, DOUBLE_EDGE, DIG
	dbp 58, SNEASLER
		db MUSCLE_BAND
		db DRAIN_PUNCH, POISON_JAB, FIRE_PUNCH, REFLECT
	dbp 58, YANMEGA
		db QUICK_CLAW
if DEF(FAITHFUL)
...
endc
	dbp 62, TYRANITAR
		db LEFTOVERS
		db EARTHQUAKE, CRUNCH, ROCK_SLIDE, DRAGON_CLAW
	dbp 61, GLISCOR
		db KINGS_ROCK
		db SWORDS_DANCE, NIGHT_SLASH, X_SCISSOR, DIG
	db -1 ; end
	...
	dbp 76, MISMAGIUS
		db BRIGHTPOWDER
		db DAZZLINGLEAM, SHADOW_BALL, NASTY_PLOT, FLAMETHROWER
	dbp 77, TOGEKISS
		db WISE_GLASSES, SHINY_MASK
		db AIR_SLASH, AURA_SPHERE, FRESH_SNACK, NASTY_PLOT
	dbp 76, SNEASLER
		db MUSCLE_BAND
		db CLOSE_COMBAT, GUNK_SHOT, SHADOW_CLAW, SWORDS_DANCE
	dbp 76, KINGDRA
		db LEFTOVERS
		db DRAGON_DANCE, OUTRAGE, WATERFALL, ICE_BEAM
	dbp 80, TYRANITAR
		db ASSAULT_VEST
		db FIRE_PUNCH, CRUNCH, STONE_EDGE, GIGA_IMPACT
	dbp 78, GLISCOR
		db KINGS_ROCK
		db SWORDS_DANCE, NIGHT_SLASH, FLY, EARTHQUAKE
	db -1 ; end
...
ValerieGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_MOVES
	; party
	dbp 37, NINETALES | ALOLAN_FORM
		db NO_ITEM
		ev_spread 224 Spe
		db ICE_BEAM, DRAINING_KISS, CONFUSE_RAY, CHARM
	dbp 37, MR__MIME
		db NO_ITEM
		ev_spread 224 HP
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 57, NINETALES, FEMALE | ALOLAN_FORM
		db WISE_GLASSES, ABILITY_1 | NAT_NEUTRAL
		ev_spread 252 SAt, 68 Spe
		db MOONBLAST, BLIZZARD, SHADOW_BALL, NASTY_PLOT
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 73, NINETALES, MALE | ALOLAN_FORM
		db WISE_GLASSES, ABILITY_1 | NAT_NEUTRAL
		db MOONBLAST, BLIZZARD, HEALINGLIGHT, NASTY_PLOT
	dbp 73, MR__MIME, FEMALE
		db QUICK_CLAW, ABILITY_1 | NAT_NEUTRAL
		db PSYCHIC_M, DAZZLINGLEAM, LIGHT_SCREEN, REFLECT
...
KatyGroup:
	...
	; party
	; TODO: movesets, etc
	dbp LEVEL_FROM_BADGES + 18, ARIADOS
	dbp LEVEL_FROM_BADGES + 19, BUTTERFREE
	dbp LEVEL_FROM_BADGES + 20, SHUCKLE
	dbp LEVEL_FROM_BADGES + 20, KLEAVOR
	dbp LEVEL_FROM_BADGES + 18, HERACROSS
	dbp LEVEL_FROM_BADGES + 21, URSARING
	db -1 ; end
	...
	; party
	; TODO: movesets, etc
	dbp LEVEL_FROM_BADGES + 8, ARIADOS
	dbp LEVEL_FROM_BADGES + 7, BUTTERFREE
	dbp LEVEL_FROM_BADGES + 8, SHUCKLE
	dbp LEVEL_FROM_BADGES + 8, KLEAVOR
	dbp LEVEL_FROM_BADGES + 9, HERACROSS
	dbp LEVEL_FROM_BADGES + 11, URSALUNA
	db -1 ; end
