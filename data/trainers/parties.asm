...
ClairGroup:
	...
	dbp 72, DRAGONITE, FEMALE
		db LEFTOVERS, ABIL_DRAGONITE_MULTISCALE | NAT_ATK_UP_SATK_DOWN
		db OUTRAGE, DRAGON_DANCE, FIRE_PUNCH, EARTHQUAKE
	...
	dbp 74, DRAGONAIR, FEMALE
		db EVIOLITE, ABIL_DRAGONAIR_MARVEL_SCALE | NAT_SATK_UP_ATK_DOWN
		db DRAGON_PULSE, FLAMETHROWER, OUTRAGE, AQUA_TAIL
...
BrunoGroup:
	...
	dbp 72, STEELIX, MALE
		db SITRUS_BERRY, ABIL_STEELIX_STURDY | NAT_DEF_UP_SATK_DOWN
		db LEFTOVERS
		db CURSE, EARTHQUAKE, STONE_EDGE, IRON_HEAD
	dbp 74, MACHAMP, MALE
		db FLAME_ORB, ABIL_MACHAMP_GUTS | NAT_SATK_UP_ATK_DOWN
