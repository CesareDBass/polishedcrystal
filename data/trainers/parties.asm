...
if DEF(FAITHFUL)
	dbp 73, DELIBIRD
		db LIECHI_BERRY, FAKE_PERFECT_DVS, ABIL_DELIBIRD_HUSTLE | NAT_ATK_UP_SATK_DOWN
		db SPIKES, ICICLE_SPEAR, ACROBATICS, DESTINY_BOND
else
	dbp 73, DELIBIRD
		db LIECHI_BERRY, FAKE_PERFECT_DVS, ABIL_DELIBIRD_UNBURDEN | NAT_ATK_UP_SATK_DOWN
		db SPIKES, ICICLE_SPEAR, ACROBATICS, DESTINY_BOND
endc
	dbp 73, DEWGONG
		db ICY_ROCK, FAKE_PERFECT_DVS, ABIL_DEWGONG_ICE_BODY | NAT_ATK_UP_SATK_DOWN
		db HAIL, TOXIC, SURF, BLIZZARD
	dbp 72, WEAVILE
		db KINGS_ROCK, FAKE_PERFECT_DVS, ABIL_WEAVILE_PRESSURE | NAT_ATK_UP_SATK_DOWN
		db SWORDS_DANCE, ICICLE_CRASH, NIGHT_SLASH, POISON_JAB
	dbp 71, SANDSLASH, ALOLAN_FORM
	...
	dbp 73, MR__RIME
		db LEFTOVERS, FAKE_PERFECT_DVS, ABIL_MR__RIME_ICE_BODY | NAT_ATK_UP_SATK_DOWN
...
if DEF(FAITHFUL)
		...
		db BUG_BUZZ, DRAGON_PULSE, ANCIENTPOWER, GIGA_DRAIN
