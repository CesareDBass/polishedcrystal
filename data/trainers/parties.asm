...
FalknerGroup:
	...
	dbp 70, SKARMORY
		db LEFTOVERS, ABIL_SKARMORY_STURDY | NAT_SPE_UP_SDEF_DOWN
...
endc
	...
	dbp 75, SCIZOR, FEMALE
		...
		db SWORDS_DANCE, NIGHT_SLASH, X_SCISSOR, IRON_HEAD
	db -1 ; end
...
WhitneyGroup:
	...
	dbp 74, TAUROS, FEMALE
		db SILK_SCARF, SHINY_MASK  ABILITY_1 | NAT_NEUTRAL
...
endc
	...
	dbp 72, GRANBULL, MALE
		db TOXIC_ORB, ABIL_GRANBULL_QUICK_FEET | NAT_NEUTRAL
		db PLAY_ROUGH, CLOSE_COMBAT, FIRE_PUNCH, FACADE
	dbp 72, TAUROS, MALE | PALDEAN_FORM
		db QUICK_CLAW, ABIL_TAUROS_PALDEAN_INTIMIDATE | NAT_NEUTRAL
