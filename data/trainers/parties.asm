...
WhitneyGroup:
	...
	dbp 19, MUNCHLAX, FEMALE
		db NO_ITEM, ABIL_MUNCHLAX_THICK_FAT | NAT_NEUTRAL
...
if DEF(FAITHFUL)
	dbp 73, HAUNTER, MALE
		db EVIOLITE, ABIL_HAUNTER_LEVITATE | NAT_SATK_UP_ATK_DOWN
...
endc
	...
	dbp 71, SANDSLASH, MALE | ALOLAN_FORM
		db NEVERMELTICE, FAKE_PERFECT_DVS, ABIL_SANDSLASH_SLUSH_RUSH | NAT_ATK_UP_SATK_DOWN
...
ClairGroup:
	...
	dbp 70, GYARADOS, FEMALE
		db BRIGHTPOWDER, ABILITY_GYARADOS_INTIMIDATE | NAT_SPE_UP_SATK_DOWN
		db DRAGON_DANCE, WATERFALL, FLY, EARTHQUAKE
	dbp 72, DRAGONITE, FEMALE
		db LEFTOVERS, ABILITY_DRAGONITE_MULTISCALE | NAT_ATK_UP_SATK_DOWN
		db OUTRAGE, DRAGON_DANCE, FIRE_PUNCH, EARTHQUAKE
	dbp 73, AMPHAROS, FEMALE
		db DRAGON_FANG, ABILITY_AMPHAROS_MOLD_BREAKER | NAT_SATK_UP_ATK_DOWN
		db THUNDERBOLT, DRAGON_PULSE, DAZZLINGLEAM, THUNDER_WAVE
	dbp 72, LAPRAS, FEMALE
		db CLEAR_AMULET, ABILITY_LAPRAS_SHELL_ARMOR | NAT_ATK_UP_SATK_DOWN
		db ICE_SHARD, WATERFALL, DRAGON_DANCE, OUTRAGE
	dbp 74, DRAGONAIR, FEMALE
		db EVIOLITE, ABILITY_DRAGONAIR_MARVEL_SCALE | NAT_SATK_UP_ATK_DOWN
...
WillGroup:
	...
	dbp 70, XATU, MALE
		db LEFTOVERS, FAKE_HP_FIGHTING, ABIL_XATU_MAGIC_BOUNCE | NAT_ATK_UP_SATK_DOWN
...
KogaGroup:
	...
	dbp 69, OVERQWIL, MALE
		db LEFTOVERS, ABILITY_OVERQWIL_POISON_POINT | NAT_SDEF_UP_SATK_DOWN
		db SPIKES, DESTINY_BOND, POISON_JAB, CRUNCH
	dbp 71, ARIADOS, MALE
		db MUSCLE_BAND, ABILITY_ARIADOS_SNIPER | NAT_SPE_UP_SATK_DOWN
		db GLARE, LEECH_LIFE, NIGHT_SLASH, TOXIC_SPIKES
	dbp 69, ARBOK, MALE | ARBOK_KOGA_FORM
		db SOFT_SAND, ABILITY_ARBOK_INTIMIDATE | NAT_ATK_UP_SATK_DOWN
		db POISON_JAB, GLARE, EARTHQUAKE, SCREECH
	dbp 70, WEEZING, MALE
		db WISE_GLASSES, ABILITY_WEEZING_LEVITATE | NAT_SATK_UP_ATK_DOWN
		db WILL_O_WISP, THUNDER, SLUDGE_BOMB, EXPLOSION
	dbp 71, CROBAT, MALE
		db SCOPE_LENS, ABILITY_CROBAT_INFILTRATOR | NAT_SPE_UP_SATK_DOWN
		db SCREECH, TOXIC, CRUNCH, AERIAL_ACE
	dbp 72, MUK, MALE
		db BRIGHTPOWDER, ABILITY_MUK_POISON_TOUCH | NAT_ATK_UP_SATK_DOWN
