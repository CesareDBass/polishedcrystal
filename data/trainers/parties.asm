...
LtSurgeGroup:
	...
	dbp 56, ELECTRODE | HISUIAN_FORM
		...
		db SCREECH, SEED_BOMB, WILD_CHARGE, EXPLOSION
	dbp 58, GOLEM | ALOLAN_FORM
		db NO_ITEM
		ev_spread 36 Atk, 252 SAt
		db ROCK_SLIDE, THUNDER_WAVE, THUNDERPUNCH, EARTHQUAKE
	dbp 60, RAICHU
		db SITRUS_BERRY
		ev_spread 36 Atk, 252 SAt
	...
	dbp 72, ELECTRODE | HISUIAN_FORM
		db SILK_SCARF, FAKE_PERFECT_DVS
		db REFLECT, DOUBLE_TEAM, ENERGY_BALL, THUNDER
	dbp 73, GOLEM | ALOLAN_FORM
		db ZOOM_LENS, FAKE_PERFECT_DVS
		db STONE_EDGE, WILD_CHARGE, GYRO_BALL, THUNDER_WAVE
	dbp 72, MAGNEZONE
