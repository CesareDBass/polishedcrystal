...
PryceGroup:
	...
	; party
	dbp 73, DELIBIRD
		db LIECHI_BERRY, FAKE_PERFECT_DVS, ABIL_DELIBIRD_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db SPIKES, ICICLE_SPEAR, ACROBATICS, DESTINY_BOND
	dbp 73, DEWGONG
		db FOCUS_BAND, FAKE_PERFECT_DVS, ABIL_DEWGONG_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db PROTECT, TOXIC, SURF, ICE_BEAM
	dbp 72, WEAVILE
		db KINGS_ROCK, FAKE_PERFECT_DVS, ABIL_WEAVILE_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db SWORDS_DANCE, ICICLE_CRASH, SLASH, CRUNCH
	dbp 71, GLACEON
		db NEVERMELTICE, DVS_HP_GROUND, ABIL_GLACEON_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db ICE_BEAM, HIDDEN_POWER, BARRIER, BATON_PASS
	dbp 73, MR__RIME
		db LEFTOVERS, FAKE_PERFECT_DVS, ABIL_MR__RIME_ICE_BODY | NAT_ATK_UP_SATK_DOWN
		db SURF, TOXIC, ICE_BEAM, THUNDERBOLT
	dbp 75, MAMOSWINE
		db HARD_STONE, FAKE_PERFECT_DVS, ABIL_MAMOSWINE_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
